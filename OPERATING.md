...
|---|---|---|
| **PolicyData (oracle)** | The reusable WASM-oracle contract a pack publishes. Address + `wasmCid` live in [`deployments.json`](./deployments.json) (`packs.<name>.<chain_id>.policyData`). | Newton / this repo, per pack |
