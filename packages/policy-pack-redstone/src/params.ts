...
export const ParamsSchema = z
	.object({
		...
		max_feed_age_seconds: z
			.number()
			.describe("Maximum allowed age of the RedStone price feed in seconds. Stale feeds deny."),
		enable_sustained_check: z
			.boolean()
			.describe(
