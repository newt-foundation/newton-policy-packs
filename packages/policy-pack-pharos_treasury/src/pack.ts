...
/**
 * The Pharos risk-adjusted treasury `PolicyPack`.
 *
 * Admits a stablecoin only when there is no active depeg, stress is below threshold, the
 * redemption route is approved, and exit capacity comfortably exceeds the resulting
 * position - so a treasury never judges a stablecoin on price alone.
 *
 ...
 */
export const pharos_treasury = defineOracle({
	id: `${PACK_NAME}/treasury-risk/v1`,
