...
- c03bc58: Add `definePolicyPack`, the one pack factory: first-party packs and custom
...
- c5e4c89: Add `defineCustomModule` for composing a custom oracle alongside published packs.
...
- 098a8aa: Harden `generateCompositeParamsSchema` and relax the `paramsJsonSchema` interface requirement.
