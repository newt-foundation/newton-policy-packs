...
/**
 * The Arkham entity-aware wallet `PolicyPack`.
 *
 * Tiers a spending limit by Arkham entity attribution: a verified, approved-category
 * destination gets the full tier, an unlabelled one gets an introductory cap, and a
 * prohibited risk tag denies outright.
 *
 ...
 */
export const arkham_entity = defineOracle({
	id: `${PACK_NAME}/entity-wallet/v1`,
